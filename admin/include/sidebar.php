				...
				<ul id="togglePages" class="collapse unstyled">
					<li>
						<a href="index.php">
							...
							$t1 = "23:59:59";
							$to = date('Y-m-d') . " " . $t1;
							$result = mysqli_query($con, "SELECT * FROM orders_info where Start_Date Between '$from' and '$to'");
					...
					<li>
						<a href="index.php">
							...
							<?php
							$status = 'Delivered';
							$ret = mysqli_query($con, "SELECT * FROM orders_info WHERE Status !='$status' || Status is null ");
					...
					<li>
						<a href="index.php">
							...
							<?php
							$status = 'Delivered';
							$rt = mysqli_query($con, "SELECT * FROM orders_info where Status='$status'");
