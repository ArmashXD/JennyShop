...
if (!isset($_SESSION['admin_login'])) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "SELECT admin_password FROM  admin_info where admin_password='$password' && admin_email='$email'");
		$num = mysqli_fetch_array($sql);
		if ($num > 0) {
			$con = mysqli_query($con, "UPDATE admin_info SET admin_password='$newpassword'where admin_email='$email'");
